...
| the root package (the Wails facade) | 75.9% | 75% | `test.ps1` |
...
325 test functions, which expand to 375 runs once their subtests are counted.
...
139 tests across 13 files, run under Vitest with jsdom.
