// Package machinevoice times a machine voice's cast and measures making a complete script with the
// real model, the real store and the real making service (NFR-P-205, NFR-C-502). Its test takes minutes, so it carries the
